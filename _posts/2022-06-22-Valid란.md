---
layout: post
title: 스프링 - Validation Annotation이란? + DTO에서는 어디까지 검증해야할까?
date: '2022-06-22 14:00:10 +0900'
description: '자바에서 제공하는 Validiation API에 대해 알아보자'
...
자바에서는 이러한 검증을 편하게 할 수 있도록 **Java Validation API(*Bean Validation, JSR 380*)**를 제공하고 있다. Java Validation API를 사용하면 이러한 Request의 잘못된 데이터를 Service 단으로 내려오기 전에 쉽게 검증할 수 있다.
...
<img src="/assets/img/2022-06-22-Valid란/catchWrongValue.png">
...
<img src="/assets/img/2022-06-22-Valid란/SpringMVC동작방식.png">
...
<img src="/assets/img/2022-06-22-Valid란/handlerAdapter.png">
...
<img src="/assets/img/2022-06-22-Valid란/validException.png">
...
<img src="/assets/img/2022-06-22-Valid란/valid사용범위.png">
