...
```
POST API도 GET API과 같이 parameter앞에 무언가를 붙여줘야한다. Get은 데이터를 읽어오기 위해 clinet에서 읽어오고자 하는 data의 parameter를 보내고 Server는 그것을 받기 위해 @RequestParam을 붙였다면 POST는 데이터를 생성하고 추가하기 위해 아래 사진과 같이 Json 또는 XML타입의 데이터를 Client에서 보내기 때문에 Post는 Data block을 받기 위해 **@RequestBody**를 붙여준다.
<img src="https://images.velog.io/images/seongwon97/post/b6764d28-f10e-482a-bb72-038e44683e7b/post.PNG">
