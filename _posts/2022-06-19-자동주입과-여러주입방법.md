---
layout: post
title: 스프링 - 자동 주입과 여러 주입 방법
date: '2022-06-19 16:10:10 +0900'
description: '자동 주입이란 무엇이고 주입 방법에는 무엇이 있을까?'
categories: [SpringFramework, 개념 정리]
tags: [SpringFramework, Autowired, Constructor Injection, Setter Injection, Field Injection]
---
# 1. 의존성 자동주입
...
# Reference
- [초보 웹 개발자를 위한 스프링5 프로그래밍 입문 - 챕터 2, 4](https://book.naver.com/bookdb/book_detail.nhn?bid=13786861)
